from Kmeans_2 import manual_kmeans_clustering  # Import clustering function
...
def main():
    ...
    start_time_kmeans = time.time()  # Start timing KMeans
    clusters, centroids = manual_kmeans_clustering(points, num_uavs)
    elapsed_time_kmeans = time.time() - start_time_kmeans  # End timing KMeans
