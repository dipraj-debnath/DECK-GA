from Dynamic_Assignment import dynamic_assignment_clustering  # Import Dynamic Assignment function
...
def main():
    ...
    # Step 2: Run Dynamic Assignment clustering
    ...
    print(f"Total Time: {clustering_time + ga_time:.2f} seconds")
